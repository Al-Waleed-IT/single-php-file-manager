...
<body>
    <div class="login-container">
        ...
        <div class="default-creds">
            <div class="alert alert-info">Default: <strong>admin</strong> / <strong>admin</strong></div>
        </div>
    </div>
    <script>
